...
from module.flax import MLP, Attention, RMSNorm, RotaryEmbedding
from module.utils import LanguageModel, get_act_fn, get_dtype
...
class LlamaLanguageModel(LanguageModel, nnx.Module):
    def __init__(
